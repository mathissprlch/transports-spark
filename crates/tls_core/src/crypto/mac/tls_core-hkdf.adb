package body Tls_Core.Hkdf is
   ...
   begin
      ...
      Output (3) := Octet (Tls13_Prefix'Length + Label'Length);
      ...
      for I in 1 .. Label'Length loop
         Output (Label_Off + I - 1) := Label (Label'First + I - 1);
         pragma
           Loop_Invariant
             (Output (1) = Octet (Length / 256)
                ...
                and then (for all J in 1 .. Tls13_Prefix'Length =>
                            Output (Prefix_Off + J - 1) = Tls13_Prefix (J))
                and then (for all J in 1 .. I =>
      ...
      for I in 1 .. Context'Length loop
         Output (Ctx_Off + I - 1) := Context (Context'First + I - 1);
         pragma
           Loop_Invariant
             (Output (1) = Octet (Length / 256)
                and then Output (2) = Octet (Length mod 256)
                ...
                and then (for all J in 1 .. Tls13_Prefix'Length =>
                            Output (Prefix_Off + J - 1) = Tls13_Prefix (J))
                and then (for all J in 1 .. Label'Length =>
                            Output (Label_Off + J - 1)
                            = Label (Label'First + J - 1))
   ...
   begin
      Hmac_Expand (Prk => Secret, Info => Info, Output => Output);
   end Expand_Label;
