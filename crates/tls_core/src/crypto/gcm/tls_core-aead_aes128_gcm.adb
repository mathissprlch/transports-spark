...
is
   ...
   function Spec_Aes128_Encrypt_Block
     (RK : Tls_Core.Aes128.Round_Keys; Plaintext : Block_16) return Block_16
   with Ghost;
   ...
   procedure Aes128_Encrypt
     (RK        : Tls_Core.Aes128.Round_Keys;
      Plaintext : Block_16;
      Out_Block : out Block_16) is
   begin
      Tls_Core.Aes128.Encrypt_Block (RK, Plaintext, Out_Block);
   end Aes128_Encrypt;

   package Aes128_Ctr is new
     Tls_Core.Gcm_Core.Aes_Ctr_Pkg
   ...
   is
      ...
      Mac_Buf  :
        Octet_Array
          (1
           .. AAD'Length
              + Tls_Core.Gcm_Core.Pad_Len (AAD'Length)
              + Plaintext'Length
   ...
   begin
      ...
      Tls_Core.Gcm_Core.Build_Mac_Data (AAD, Ciphertext, Mac_Buf, Mac_Last);
