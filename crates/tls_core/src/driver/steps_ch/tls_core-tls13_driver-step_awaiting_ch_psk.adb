   ...
   begin
      ...
      begin
         ...
         begin
            ...
            begin
               ...
               Tls_Core.Client_Hello_Rflx.Decode_Client_Hello_Psk
                 (CH_Buf,
                  Random,
                  Sid_F,
                  Sid_L,
            ...
            begin
               while Q + 1 <= Suites_L loop
                  pragma Loop_Invariant (Q in Suites_F .. Suites_L + 1);
                  Code :=
            ...
            begin
               if Abs_Id_L - Abs_Id_F + 1 /= D.Identity_Len then
                  ...
                  for I in 1 .. D.Identity_Len loop
                     if In_Bytes (Abs_Id_F + I - 1) /= D.Identity (I) then
                        Identity_OK := False;
                     end if;
                  end loop;
               end if;
               ...
               begin
                  ...
                  Hs_Trunc (1 .. Trunc_Len) := In_Bytes (Rec_F .. Abs_T_Last);
      ...
      if D.Hrr_Demand and then not D.Hrr_Sent then
         ...
         begin
            ...
            Encode_Hs_Message
              (Hs_Type_SH, Hrr_Body (1 .. Hrr_Body_Last), Hrr_Hs, Hrr_Hs_Last);
            ...
            Out_Buf (1 .. Hrr_Rec_Last) := Hrr_Rec (1 .. Hrr_Rec_Last);
