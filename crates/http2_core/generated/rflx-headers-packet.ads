...
is
   ...
   type Virtual_Field is (F_Initial, F_Field_Block_Fragment, F_Final);

   subtype Field is Virtual_Field range F_Field_Block_Fragment .. F_Field_Block_Fragment;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and RFLX.Headers.Packet.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       RFLX.Headers.Packet.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       RFLX.Headers.Packet.Has_Buffer (Ctx)
       and then RFLX.Headers.Packet.Well_Formed_Message (Ctx)
       and then RFLX.Headers.Packet.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Headers.Packet.Has_Buffer (Ctx)
       and then Offset < RFLX.Headers.Packet.Buffer_Length (Ctx)
       and then Pre (RFLX.Headers.Packet.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       RFLX.Headers.Packet.Has_Buffer (Ctx)
       and then RFLX.Headers.Packet.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.Headers.Packet.Byte_Size (Ctx);
   ...
   with
     Pre =>
       RFLX.Headers.Packet.Has_Buffer (Ctx)
       and then RFLX.Headers.Packet.Valid_Next (Ctx, Fld)
       and then RFLX.Headers.Packet.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       RFLX.Headers.Packet.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
           when F_Field_Block_Fragment =>
   ...
   with
     Pre =>
       RFLX.Headers.Packet.Has_Buffer (Ctx)
       and RFLX.Headers.Packet.Valid_Next (Ctx, Fld);
   ...
   function Get_Field_Block_Fragment (Ctx : Context) return RFLX_Types.Bytes
   with
     Ghost,
     Pre =>
       RFLX.Headers.Packet.Has_Buffer (Ctx)
       and then RFLX.Headers.Packet.Well_Formed (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment)
       and then RFLX.Headers.Packet.Valid_Next (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment),
     Post =>
       Get_Field_Block_Fragment'Result'Length = RFLX_Types.To_Length (Field_Size (Ctx, F_Field_Block_Fragment));

   procedure Get_Field_Block_Fragment (Ctx : Context; Data : out RFLX_Types.Bytes)
   with
     Pre =>
       RFLX.Headers.Packet.Has_Buffer (Ctx)
       and then RFLX.Headers.Packet.Well_Formed (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment)
       and then RFLX.Headers.Packet.Valid_Next (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment)
       and then Data'Length = RFLX_Types.To_Length (RFLX.Headers.Packet.Field_Size (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment)),
     Post =>
       Equal (Ctx, F_Field_Block_Fragment, Data);

   generic
      with procedure Process_Field_Block_Fragment (Field_Block_Fragment : RFLX_Types.Bytes);
   procedure Generic_Get_Field_Block_Fragment (Ctx : Context)
   with
     Pre =>
       RFLX.Headers.Packet.Has_Buffer (Ctx)
       and RFLX.Headers.Packet.Present (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment);
   ...
   procedure Set_Field_Block_Fragment_Empty (Ctx : in out Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Headers.Packet.Has_Buffer (Ctx)
       and then RFLX.Headers.Packet.Valid_Next (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment)
       and then RFLX.Headers.Packet.Available_Space (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment) >= RFLX.Headers.Packet.Field_Size (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment)
       and then RFLX.Headers.Packet.Field_Condition (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment)
       and then RFLX.Headers.Packet.Field_Size (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment) = 0,
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Field_Block_Fragment)
       and (if Well_Formed_Message (Ctx) then Message_Last (Ctx) = Field_Last (Ctx, F_Field_Block_Fragment))
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and Ctx.First = Ctx.First'Old
       and Ctx.Last = Ctx.Last'Old
       and Valid_Next (Ctx, F_Field_Block_Fragment) = Valid_Next (Ctx, F_Field_Block_Fragment)'Old
       and Field_First (Ctx, F_Field_Block_Fragment) = Field_First (Ctx, F_Field_Block_Fragment)'Old;

   procedure Initialize_Field_Block_Fragment (Ctx : in out Context; Length : RFLX_Types.Length)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Headers.Packet.Has_Buffer (Ctx)
       and then RFLX.Headers.Packet.Valid_Next (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment)
       and then RFLX.Headers.Packet.Valid_Length (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment, Length)
       and then RFLX.Headers.Packet.Available_Space (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment) >= RFLX_Types.To_Bit_Length (Length),
     Post =>
       Has_Buffer (Ctx)
       and then Well_Formed (Ctx, F_Field_Block_Fragment)
       and then Field_Size (Ctx, F_Field_Block_Fragment) = RFLX_Types.To_Bit_Length (Length)
       and then (if Well_Formed_Message (Ctx) then Message_Last (Ctx) = Field_Last (Ctx, F_Field_Block_Fragment))
       and then Ctx.Buffer_First = Ctx.Buffer_First'Old
       and then Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and then Ctx.First = Ctx.First'Old
       and then Ctx.Last = Ctx.Last'Old
       and then Valid_Next (Ctx, F_Field_Block_Fragment) = Valid_Next (Ctx, F_Field_Block_Fragment)'Old
       and then Field_First (Ctx, F_Field_Block_Fragment) = Field_First (Ctx, F_Field_Block_Fragment)'Old;

   procedure Set_Field_Block_Fragment (Ctx : in out Context; Data : RFLX_Types.Bytes)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Headers.Packet.Has_Buffer (Ctx)
       and then RFLX.Headers.Packet.Valid_Next (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment)
       and then RFLX.Headers.Packet.Available_Space (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment) >= RFLX.Headers.Packet.Field_Size (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment)
       and then RFLX.Headers.Packet.Valid_Length (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment, Data'Length)
       and then RFLX.Headers.Packet.Available_Space (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment) >= Data'Length * RFLX_Types.Byte'Size
       and then RFLX.Headers.Packet.Field_Condition (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment),
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Field_Block_Fragment)
       ...
       and Valid_Next (Ctx, F_Field_Block_Fragment) = Valid_Next (Ctx, F_Field_Block_Fragment)'Old
       and Field_First (Ctx, F_Field_Block_Fragment) = Field_First (Ctx, F_Field_Block_Fragment)'Old
       and Equal (Ctx, F_Field_Block_Fragment, Data);

   generic
      with procedure Process_Field_Block_Fragment (Field_Block_Fragment : out RFLX_Types.Bytes);
      with function Process_Data_Pre (Length : RFLX_Types.Length) return Boolean;
   procedure Generic_Set_Field_Block_Fragment (Ctx : in out Context; Length : RFLX_Types.Length)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Headers.Packet.Has_Buffer (Ctx)
       ...
       and then RFLX.Headers.Packet.Available_Space (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment) >= RFLX.Headers.Packet.Field_Size (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment)
       and then RFLX.Headers.Packet.Valid_Length (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment, Length)
       and then RFLX_Types.To_Length (RFLX.Headers.Packet.Available_Space (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment)) >= Length
...
private
   ...
   function Valid_Predecessors_Invariant (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return Boolean is
     ((if Well_Formed (Cursors (F_Field_Block_Fragment)) then True))
   with
     Pre =>
   ...
   function Field_First_Field_Block_Fragment (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return RFLX_Types.Bit_Index'Base is
     (First)
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
       and then Valid_Next_Internal (Cursors, First, Verified_Last, Written_Last, F_Field_Block_Fragment);
   ...
   function Field_First_Internal (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Fld : Field) return RFLX_Types.Bit_Index'Base is
     (case Fld is
          when F_Field_Block_Fragment =>
             Field_First_Field_Block_Fragment (Cursors, First, Verified_Last, Written_Last))
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
   ...
   function Valid_Context (Buffer_First, Buffer_Last : RFLX_Types.Index; First : RFLX_Types.Bit_Index; Last : RFLX_Types.Bit_Length; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Buffer : RFLX_Types.Bytes_Ptr; Cursors : Field_Cursors) return Boolean is
     ((if
      ...
      and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
      and then ((if
                    Well_Formed (Cursors (F_Field_Block_Fragment))
                 then
                    (Cursors (F_Field_Block_Fragment).Last - Cursors (F_Field_Block_Fragment).First + 1 = RFLX_Types.Bit_Length (Written_Last - First + 1)
                     and then Cursors (F_Field_Block_Fragment).First = First))))
   with
     Post =>
       True;
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      and then Valid_Next (Ctx, F_Field_Block_Fragment)
      and then RFLX.Headers.Packet.Field_First (Ctx, RFLX.Headers.Packet.F_Field_Block_Fragment) rem RFLX_Types.Byte'Size = 1
      and then Available_Space (Ctx, F_Field_Block_Fragment) = Ctx.Last - Ctx.First + 1
      and then Invalid (Ctx, F_Field_Block_Fragment));
   ...
   function Well_Formed_Message (Ctx : Context) return Boolean is
     (Well_Formed (Ctx, F_Field_Block_Fragment));

   function Valid_Message (Ctx : Context) return Boolean is
     (Valid (Ctx, F_Field_Block_Fragment));
