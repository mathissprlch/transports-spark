...
with RFLX.Stream.Half_Open.FSM_Allocator;
...
private
   ...
   type Private_Context is
      record
         ...
         Slots : Stream.Half_Open.FSM_Allocator.Slots;
         Memory : Stream.Half_Open.FSM_Allocator.Memory;
      end record;
   ...
   function Uninitialized (Ctx : Context) return Boolean is
     (not Frame.Packet.Has_Buffer (Ctx.P.Outgoing_Ctx)
      ...
      and Stream.Half_Open.FSM_Allocator.Uninitialized (Ctx.P.Slots));
   ...
   function Global_Allocated (Ctx : Context) return Boolean is
     (Stream.Half_Open.FSM_Allocator.Global_Allocated (Ctx.P.Slots));
