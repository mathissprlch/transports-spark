...
package body RFLX.Flow_Gate.Op_Packet
with
  SPARK_Mode
is
   ...
   with
     Pre =>
       ...
       and RFLX.Flow_Gate.Op_Packet.Valid_Next (Ctx, Fld);
   ...
   with
     Pre =>
       ...
       and then RFLX.Flow_Gate.Op_Packet.Sufficient_Buffer_Length (Ctx, Fld)
   is
   ...
   with
     Pre =>
       RFLX.Flow_Gate.Op_Packet.Has_Buffer (Ctx)
       and then RFLX.Flow_Gate.Op_Packet.Valid_Next (Ctx, Fld)
       and then RFLX.Flow_Gate.Op_Packet.Valid_Value (Fld, Val)
       and then RFLX.Flow_Gate.Op_Packet.Valid_Size (Ctx, Fld, Size)
       and then Size <= RFLX.Flow_Gate.Op_Packet.Available_Space (Ctx, Fld)
   ...
   with
     Pre =>
       ...
       and then RFLX.Flow_Gate.Op_Packet.Valid_Value (Fld, Val)
       and then RFLX.Flow_Gate.Op_Packet.Valid_Size (Ctx, Fld, RFLX.Flow_Gate.Op_Packet.Field_Size (Ctx, Fld))
       and then RFLX.Flow_Gate.Op_Packet.Available_Space (Ctx, Fld) >= RFLX.Flow_Gate.Op_Packet.Field_Size (Ctx, Fld)
       and then RFLX.Flow_Gate.Op_Packet.Field_Size (Ctx, Fld) in 1 .. RFLX_Types.Base_Integer'Size
       and then RFLX_Types.Fits_Into (Val, Natural (RFLX.Flow_Gate.Op_Packet.Field_Size (Ctx, Fld))),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, Fld)
   ...
   procedure Set_Kind (Ctx : in out Context; Val : RFLX.Flow_Gate.Op_Kind) is
   begin
