...
package RFLX.Flow_Gate.Op_Packet
with
  SPARK_Mode,
  Always_Terminates
is
   ...
   with
     Pre =>
       not Ctx'Constrained
       and RFLX.Flow_Gate.Op_Packet.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       RFLX.Flow_Gate.Op_Packet.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       RFLX.Flow_Gate.Op_Packet.Has_Buffer (Ctx)
       and then RFLX.Flow_Gate.Op_Packet.Well_Formed_Message (Ctx)
       and then RFLX.Flow_Gate.Op_Packet.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Flow_Gate.Op_Packet.Has_Buffer (Ctx)
       and then Offset < RFLX.Flow_Gate.Op_Packet.Buffer_Length (Ctx)
       and then Pre (RFLX.Flow_Gate.Op_Packet.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       RFLX.Flow_Gate.Op_Packet.Has_Buffer (Ctx)
       and then RFLX.Flow_Gate.Op_Packet.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.Flow_Gate.Op_Packet.Byte_Size (Ctx);
   ...
   with
     Pre =>
       RFLX.Flow_Gate.Op_Packet.Has_Buffer (Ctx)
       and then RFLX.Flow_Gate.Op_Packet.Valid_Next (Ctx, Fld)
       and then RFLX.Flow_Gate.Op_Packet.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       RFLX.Flow_Gate.Op_Packet.Valid_Next (Ctx, Fld);
   ...
   function Get_Kind (Ctx : Context) return RFLX.Flow_Gate.Op_Kind
   with
     Pre =>
       RFLX.Flow_Gate.Op_Packet.Valid (Ctx, RFLX.Flow_Gate.Op_Packet.F_Kind);

   function Get_Bytes (Ctx : Context) return RFLX.Flow_Gate.Window_Bytes
   with
     Pre =>
       RFLX.Flow_Gate.Op_Packet.Valid (Ctx, RFLX.Flow_Gate.Op_Packet.F_Bytes);
   ...
   procedure Set_Kind (Ctx : in out Context; Val : RFLX.Flow_Gate.Op_Kind)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.Flow_Gate.Op_Packet.Has_Buffer (Ctx)
       and then RFLX.Flow_Gate.Op_Packet.Valid_Next (Ctx, RFLX.Flow_Gate.Op_Packet.F_Kind)
       and then RFLX.Flow_Gate.Valid_Op_Kind (RFLX.Flow_Gate.To_Base_Integer (Val))
       and then RFLX.Flow_Gate.Op_Packet.Available_Space (Ctx, RFLX.Flow_Gate.Op_Packet.F_Kind) >= RFLX.Flow_Gate.Op_Packet.Field_Size (Ctx, RFLX.Flow_Gate.Op_Packet.F_Kind)
       and then RFLX.Flow_Gate.Op_Packet.Field_Condition (Ctx, RFLX.Flow_Gate.Op_Packet.F_Kind),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     ...
     Pre =>
       not Ctx'Constrained
       and then RFLX.Flow_Gate.Op_Packet.Has_Buffer (Ctx)
       and then RFLX.Flow_Gate.Op_Packet.Valid_Next (Ctx, RFLX.Flow_Gate.Op_Packet.F_Bytes)
       and then RFLX.Flow_Gate.Valid_Window_Bytes (RFLX.Flow_Gate.To_Base_Integer (Val))
       and then RFLX.Flow_Gate.Op_Packet.Available_Space (Ctx, RFLX.Flow_Gate.Op_Packet.F_Bytes) >= RFLX.Flow_Gate.Op_Packet.Field_Size (Ctx, RFLX.Flow_Gate.Op_Packet.F_Bytes)
       and then RFLX.Flow_Gate.Op_Packet.Field_Condition (Ctx, RFLX.Flow_Gate.Op_Packet.F_Bytes),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Flow_Gate.Op_Packet.Has_Buffer (Ctx)
       and then RFLX.Flow_Gate.Op_Packet.Valid_Structure (Struct)
       and then RFLX.Flow_Gate.Op_Packet.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
...
private
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then RFLX.Flow_Gate.Op_Packet.Field_First (Ctx, RFLX.Flow_Gate.Op_Packet.F_Kind) rem RFLX_Types.Byte'Size = 1
   ...
   function Valid_Value (Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          when F_Kind =>
             RFLX.Flow_Gate.Valid_Op_Kind (Val),
          when F_Bytes =>
   ...
   function Get_Kind (Ctx : Context) return RFLX.Flow_Gate.Op_Kind is
