...
package body RFLX.Stream.Bidi_Stream.FSM
with
  SPARK_Mode
is
   ...
   begin
      ...
      -- crates/http2_core/specs/stream.rflx:295:10
   ...
   begin
      ...
      -- crates/http2_core/specs/stream.rflx:306:10
      Frame.Packet.Verify_Message (Ctx.P.Outgoing_Ctx);
      Ctx.P.Next_State := S_Try_Send;
      pragma Assert (Sending_Headers_Invariant);
   end Sending_Headers;

   procedure Try_Send (Ctx : in out Context)
   with
     Pre =>
       Initialized (Ctx),
     Post =>
       Initialized (Ctx)
   is
      function Try_Send_Invariant return Boolean is
        (True)
      with
        Annotate =>
          (GNATprove, Inline_For_Proof),
        Ghost;
   begin
      pragma Assert (Try_Send_Invariant);
      -- crates/http2_core/specs/stream.rflx:316:10
      Frame.Packet.Verify_Message (Ctx.P.Outgoing_Ctx);
      if Frame.Packet.Well_Formed_Message (Ctx.P.Outgoing_Ctx) then
         Ctx.P.Next_State := S_Sending_Data;
      else
         Ctx.P.Next_State := S_Try_Recv;
      end if;
      pragma Assert (Try_Send_Invariant);
   end Try_Send;
   ...
   begin
      ...
      -- crates/http2_core/specs/stream.rflx:327:10
      Frame.Packet.Verify_Message (Ctx.P.Outgoing_Ctx);
      -- crates/http2_core/specs/stream.rflx:330:16
      ...
      pragma Warnings (On, "condition is always False");
      pragma Warnings (On, "condition can only be False if invalid values present");
      -- crates/http2_core/specs/stream.rflx:330:35
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      if T_1 = 1 then
         Ctx.P.Next_State := S_Closing_Local;
      else
         Ctx.P.Next_State := S_Try_Send;
      end if;
      pragma Assert (Sending_Data_Invariant);
   ...
   procedure Closing_Local (Ctx : in out Context)
   with
     Pre =>
       Initialized (Ctx),
     Post =>
   ...
   is
      ...
      T_22 : Boolean;
      function Closing_Local_Invariant return Boolean is
        (True)
      with
        Annotate =>
          (GNATprove, Inline_For_Proof),
        Ghost;
   begin
      pragma Assert (Closing_Local_Invariant);
      -- crates/http2_core/specs/stream.rflx:340:10
      Frame.Packet.Verify_Message (Ctx.P.Inbound_Ctx);
      -- crates/http2_core/specs/stream.rflx:343:16
      T_2 := Frame.Packet.Well_Formed_Message (Ctx.P.Inbound_Ctx);
      -- crates/http2_core/specs/stream.rflx:344:21
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      -- crates/http2_core/specs/stream.rflx:345:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      T_7 := T_4
      or else T_6;
      -- crates/http2_core/specs/stream.rflx:347:16
      T_8 := Frame.Packet.Well_Formed_Message (Ctx.P.Inbound_Ctx);
      -- crates/http2_core/specs/stream.rflx:348:21
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      -- crates/http2_core/specs/stream.rflx:349:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      T_13 := T_10
      or else T_12;
      -- crates/http2_core/specs/stream.rflx:350:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      T_16 := T_13
      or else T_15;
      -- crates/http2_core/specs/stream.rflx:351:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      T_19 := T_16
      or else T_18;
      -- crates/http2_core/specs/stream.rflx:353:16
      T_20 := Frame.Packet.Well_Formed_Message (Ctx.P.Inbound_Ctx);
      -- crates/http2_core/specs/stream.rflx:354:20
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      if
         ...
         and then T_7
      then
         Ctx.P.Next_State := S_Forwarding_Inbound_End;
      elsif
         T_8
         and then T_19
      then
      ...
      pragma Assert (Closing_Local_Invariant);
      <<Finalize_Closing_Local>>
   end Closing_Local;

   procedure Forwarding_Inbound_End (Ctx : in out Context)
   with
     Pre =>
       Initialized (Ctx),
     Post =>
       Initialized (Ctx)
   is
      function Forwarding_Inbound_End_Invariant return Boolean is
        (True)
      with
        Annotate =>
          (GNATprove, Inline_For_Proof),
        Ghost;
   begin
      pragma Assert (Forwarding_Inbound_End_Invariant);
      -- crates/http2_core/specs/stream.rflx:362:10
      Frame.Packet.Verify_Message (Ctx.P.Inbound_Ctx);
      Ctx.P.Next_State := S_Closing_Local;
      pragma Assert (Forwarding_Inbound_End_Invariant);
   end Forwarding_Inbound_End;

   procedure Try_Recv (Ctx : in out Context)
   with
     Pre =>
       Initialized (Ctx),
     Post =>
   ...
   is
      ...
      T_25 : Boolean;
      T_26 : Http2_Parameters.HTTP_2_Frame_Type;
      T_27 : Boolean;
      T_28 : Boolean;
      T_29 : Boolean;
      T_30 : Http2_Parameters.HTTP_2_Frame_Type;
      T_31 : Boolean;
      T_32 : Http2_Parameters.HTTP_2_Frame_Type;
      T_33 : Boolean;
      T_34 : Boolean;
      T_35 : Http2_Parameters.HTTP_2_Frame_Type;
      T_36 : Boolean;
      T_37 : Boolean;
      T_38 : Http2_Parameters.HTTP_2_Frame_Type;
      T_39 : Boolean;
      T_40 : Boolean;
      T_41 : Boolean;
      T_42 : Http2_Parameters.HTTP_2_Frame_Type;
      T_43 : Boolean;
      function Try_Recv_Invariant return Boolean is
        (True)
      with
        Annotate =>
          (GNATprove, Inline_For_Proof),
        Ghost;
   begin
      pragma Assert (Try_Recv_Invariant);
      -- crates/http2_core/specs/stream.rflx:369:10
      Frame.Packet.Verify_Message (Ctx.P.Inbound_Ctx);
      -- crates/http2_core/specs/stream.rflx:372:16
      T_23 := Frame.Packet.Well_Formed_Message (Ctx.P.Inbound_Ctx);
      -- crates/http2_core/specs/stream.rflx:373:21
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      -- crates/http2_core/specs/stream.rflx:373:21
      T_25 := T_24 = (Known => True, Enum => Http2_Parameters.HEADERS);
      -- crates/http2_core/specs/stream.rflx:374:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      pragma Warnings (On, "condition can only be False if invalid values present");
      -- crates/http2_core/specs/stream.rflx:374:24
      T_26 := Frame.Packet.Get_Frame_Type (Ctx.P.Inbound_Ctx);
      -- crates/http2_core/specs/stream.rflx:374:24
      T_27 := T_26 = (Known => True, Enum => Http2_Parameters.DATA);
      -- crates/http2_core/specs/stream.rflx:373:21
      T_28 := T_25
      or else T_27;
      -- crates/http2_core/specs/stream.rflx:376:16
      T_29 := Frame.Packet.Well_Formed_Message (Ctx.P.Inbound_Ctx);
      -- crates/http2_core/specs/stream.rflx:377:21
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      pragma Warnings (On, "condition can only be False if invalid values present");
      -- crates/http2_core/specs/stream.rflx:377:21
      T_30 := Frame.Packet.Get_Frame_Type (Ctx.P.Inbound_Ctx);
      -- crates/http2_core/specs/stream.rflx:377:21
      T_31 := T_30 = (Known => True, Enum => Http2_Parameters.SETTINGS);
      -- crates/http2_core/specs/stream.rflx:378:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      pragma Warnings (On, "condition can only be False if invalid values present");
      -- crates/http2_core/specs/stream.rflx:378:24
      T_32 := Frame.Packet.Get_Frame_Type (Ctx.P.Inbound_Ctx);
      -- crates/http2_core/specs/stream.rflx:378:24
      T_33 := T_32 = (Known => True, Enum => Http2_Parameters.PING);
      -- crates/http2_core/specs/stream.rflx:377:21
      T_34 := T_31
      or else T_33;
      -- crates/http2_core/specs/stream.rflx:379:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      pragma Warnings (On, "condition can only be False if invalid values present");
      -- crates/http2_core/specs/stream.rflx:379:24
      T_35 := Frame.Packet.Get_Frame_Type (Ctx.P.Inbound_Ctx);
      -- crates/http2_core/specs/stream.rflx:379:24
      T_36 := T_35 = (Known => True, Enum => Http2_Parameters.WINDOW_UPDATE);
      -- crates/http2_core/specs/stream.rflx:377:21
      T_37 := T_34
      or else T_36;
      -- crates/http2_core/specs/stream.rflx:380:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      pragma Warnings (On, "condition can only be False if invalid values present");
      -- crates/http2_core/specs/stream.rflx:380:24
      T_38 := Frame.Packet.Get_Frame_Type (Ctx.P.Inbound_Ctx);
      -- crates/http2_core/specs/stream.rflx:380:24
      T_39 := T_38 = (Known => True, Enum => Http2_Parameters.GOAWAY);
      -- crates/http2_core/specs/stream.rflx:377:21
      T_40 := T_37
      or else T_39;
      -- crates/http2_core/specs/stream.rflx:382:16
      T_41 := Frame.Packet.Well_Formed_Message (Ctx.P.Inbound_Ctx);
      -- crates/http2_core/specs/stream.rflx:383:20
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      pragma Warnings (On, "condition can only be False if invalid values present");
      -- crates/http2_core/specs/stream.rflx:383:20
      T_42 := Frame.Packet.Get_Frame_Type (Ctx.P.Inbound_Ctx);
      -- crates/http2_core/specs/stream.rflx:383:20
      T_43 := T_42 = (Known => True, Enum => Http2_Parameters.RST_STREAM);
      if
         T_23
         and then T_28
      then
   ...
   begin
      ...
      -- crates/http2_core/specs/stream.rflx:391:10
      Frame.Packet.Verify_Message (Ctx.P.Inbound_Ctx);
      Ctx.P.Next_State := S_Try_Send;
      pragma Assert (Forwarding_Inbound_Invariant);
   ...
   begin
      ...
      -- crates/http2_core/specs/stream.rflx:398:10
      Frame.Packet.Verify_Message (Ctx.P.Inbound_Ctx);
      Ctx.P.Next_State := S_Try_Send;
      pragma Assert (Forwarding_Connection_Frame_Invariant);
   ...
   begin
      ...
      -- crates/http2_core/specs/stream.rflx:405:10
      Frame.Packet.Verify_Message (Ctx.P.Inbound_Ctx);
      Ctx.P.Next_State := S_Final;
      pragma Assert (Forwarding_Reset_Invariant);
   ...
   function In_IO_State (Ctx : Context) return Boolean is
     (Ctx.P.Next_State in S_Loading_Headers | S_Sending_Headers | S_Try_Send | S_Sending_Data | S_Closing_Local | S_Forwarding_Inbound_End | S_Try_Recv | S_Forwarding_Inbound | S_Forwarding_Connection_Frame | S_Forwarding_Reset);
