...
is
   ...
   type Virtual_Field is (F_Initial, F_Opaque_Data, F_Final);

   subtype Field is Virtual_Field range F_Opaque_Data .. F_Opaque_Data;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and RFLX.Ping.Packet.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       RFLX.Ping.Packet.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       RFLX.Ping.Packet.Has_Buffer (Ctx)
       and then RFLX.Ping.Packet.Well_Formed_Message (Ctx)
       and then RFLX.Ping.Packet.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Ping.Packet.Has_Buffer (Ctx)
       and then Offset < RFLX.Ping.Packet.Buffer_Length (Ctx)
       and then Pre (RFLX.Ping.Packet.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       RFLX.Ping.Packet.Has_Buffer (Ctx)
       and then RFLX.Ping.Packet.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.Ping.Packet.Byte_Size (Ctx);
   ...
   with
     Pre =>
       RFLX.Ping.Packet.Has_Buffer (Ctx)
       and then RFLX.Ping.Packet.Valid_Next (Ctx, Fld)
       and then RFLX.Ping.Packet.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       RFLX.Ping.Packet.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
           when F_Opaque_Data =>
   ...
   with
     Pre =>
       RFLX.Ping.Packet.Has_Buffer (Ctx)
       and RFLX.Ping.Packet.Valid_Next (Ctx, Fld);
   ...
   function Get_Opaque_Data (Ctx : Context) return RFLX_Types.Bytes
   with
     Ghost,
     Pre =>
       RFLX.Ping.Packet.Has_Buffer (Ctx)
       and then RFLX.Ping.Packet.Well_Formed (Ctx, RFLX.Ping.Packet.F_Opaque_Data)
       and then RFLX.Ping.Packet.Valid_Next (Ctx, RFLX.Ping.Packet.F_Opaque_Data),
     Post =>
       Get_Opaque_Data'Result'Length = RFLX_Types.To_Length (Field_Size (Ctx, F_Opaque_Data));

   procedure Get_Opaque_Data (Ctx : Context; Data : out RFLX_Types.Bytes)
   with
     Pre =>
       RFLX.Ping.Packet.Has_Buffer (Ctx)
       and then RFLX.Ping.Packet.Well_Formed (Ctx, RFLX.Ping.Packet.F_Opaque_Data)
       and then RFLX.Ping.Packet.Valid_Next (Ctx, RFLX.Ping.Packet.F_Opaque_Data)
       and then Data'Length = RFLX_Types.To_Length (RFLX.Ping.Packet.Field_Size (Ctx, RFLX.Ping.Packet.F_Opaque_Data)),
     Post =>
       Equal (Ctx, F_Opaque_Data, Data);

   generic
      with procedure Process_Opaque_Data (Opaque_Data : RFLX_Types.Bytes);
   procedure Generic_Get_Opaque_Data (Ctx : Context)
   with
     Pre =>
       RFLX.Ping.Packet.Has_Buffer (Ctx)
       and RFLX.Ping.Packet.Present (Ctx, RFLX.Ping.Packet.F_Opaque_Data);
   ...
   procedure Initialize_Opaque_Data (Ctx : in out Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Ping.Packet.Has_Buffer (Ctx)
       and then RFLX.Ping.Packet.Valid_Next (Ctx, RFLX.Ping.Packet.F_Opaque_Data)
       and then RFLX.Ping.Packet.Available_Space (Ctx, RFLX.Ping.Packet.F_Opaque_Data) >= RFLX.Ping.Packet.Field_Size (Ctx, RFLX.Ping.Packet.F_Opaque_Data),
     Post =>
       Has_Buffer (Ctx)
       and then Well_Formed (Ctx, F_Opaque_Data)
       and then (if Well_Formed_Message (Ctx) then Message_Last (Ctx) = Field_Last (Ctx, F_Opaque_Data))
       and then Ctx.Buffer_First = Ctx.Buffer_First'Old
       and then Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and then Ctx.First = Ctx.First'Old
       and then Ctx.Last = Ctx.Last'Old
       and then Valid_Next (Ctx, F_Opaque_Data) = Valid_Next (Ctx, F_Opaque_Data)'Old
       and then Field_First (Ctx, F_Opaque_Data) = Field_First (Ctx, F_Opaque_Data)'Old;

   procedure Set_Opaque_Data (Ctx : in out Context; Data : RFLX_Types.Bytes)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Ping.Packet.Has_Buffer (Ctx)
       and then RFLX.Ping.Packet.Valid_Next (Ctx, RFLX.Ping.Packet.F_Opaque_Data)
       and then RFLX.Ping.Packet.Available_Space (Ctx, RFLX.Ping.Packet.F_Opaque_Data) >= RFLX.Ping.Packet.Field_Size (Ctx, RFLX.Ping.Packet.F_Opaque_Data)
       and then RFLX.Ping.Packet.Valid_Length (Ctx, RFLX.Ping.Packet.F_Opaque_Data, Data'Length)
       and then RFLX.Ping.Packet.Available_Space (Ctx, RFLX.Ping.Packet.F_Opaque_Data) >= Data'Length * RFLX_Types.Byte'Size
       and then RFLX.Ping.Packet.Field_Condition (Ctx, RFLX.Ping.Packet.F_Opaque_Data),
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Opaque_Data)
       and (if Well_Formed_Message (Ctx) then Message_Last (Ctx) = Field_Last (Ctx, F_Opaque_Data))
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and Ctx.First = Ctx.First'Old
       and Ctx.Last = Ctx.Last'Old
   ...
   procedure Generic_Set_Opaque_Data (Ctx : in out Context; Length : RFLX_Types.Length)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Ping.Packet.Has_Buffer (Ctx)
       and then RFLX.Ping.Packet.Valid_Next (Ctx, RFLX.Ping.Packet.F_Opaque_Data)
       and then RFLX.Ping.Packet.Available_Space (Ctx, RFLX.Ping.Packet.F_Opaque_Data) >= RFLX.Ping.Packet.Field_Size (Ctx, RFLX.Ping.Packet.F_Opaque_Data)
       and then RFLX.Ping.Packet.Valid_Length (Ctx, RFLX.Ping.Packet.F_Opaque_Data, Length)
       and then RFLX_Types.To_Length (RFLX.Ping.Packet.Available_Space (Ctx, RFLX.Ping.Packet.F_Opaque_Data)) >= Length
   ...
   type Structure is
      record
         Opaque_Data : RFLX_Types.Bytes (RFLX_Types.Index'First .. RFLX_Types.Index'First + 7);
      end record;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Ping.Packet.Has_Buffer (Ctx)
       and then RFLX.Ping.Packet.Valid_Structure (Struct)
       and then RFLX.Ping.Packet.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
   ...
   function Field_Size_Opaque_Data (Struct : Structure) return RFLX_Types.Bit_Length
   with
     Pre =>
       Valid_Structure (Struct);
...
private
   ...
   function Valid_Predecessors_Invariant (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return Boolean is
     ((if Well_Formed (Cursors (F_Opaque_Data)) then True))
   with
     Pre =>
   ...
   function Field_First_Opaque_Data (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return RFLX_Types.Bit_Index'Base is
     (First)
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
       and then Valid_Next_Internal (Cursors, First, Verified_Last, Written_Last, F_Opaque_Data);
   ...
   function Field_First_Internal (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Fld : Field) return RFLX_Types.Bit_Index'Base is
     (case Fld is
          when F_Opaque_Data =>
             Field_First_Opaque_Data (Cursors, First, Verified_Last, Written_Last))
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
   ...
   function Valid_Context (Buffer_First, Buffer_Last : RFLX_Types.Index; First : RFLX_Types.Bit_Index; Last : RFLX_Types.Bit_Length; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Buffer : RFLX_Types.Bytes_Ptr; Cursors : Field_Cursors) return Boolean is
     ((if
      ...
      and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
      and then ((if
                    Well_Formed (Cursors (F_Opaque_Data))
                 then
                    (Cursors (F_Opaque_Data).Last - Cursors (F_Opaque_Data).First + 1 = 64
                     and then Cursors (F_Opaque_Data).First = First))))
   with
     Post =>
       True;
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      and then Valid_Next (Ctx, F_Opaque_Data)
      and then RFLX.Ping.Packet.Field_First (Ctx, RFLX.Ping.Packet.F_Opaque_Data) rem RFLX_Types.Byte'Size = 1
      and then Available_Space (Ctx, F_Opaque_Data) = Ctx.Last - Ctx.First + 1
      and then Invalid (Ctx, F_Opaque_Data));
   ...
   function Field_Size_Opaque_Data (Struct : Structure) return RFLX_Types.Bit_Length is
     (64);

end RFLX.Ping.Packet;
