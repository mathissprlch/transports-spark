...
with RFLX.Session.Unsubscribing.FSM_Allocator;
...
private
   ...
   type Private_Context is
      record
         ...
         Slots : Session.Unsubscribing.FSM_Allocator.Slots;
         Memory : Session.Unsubscribing.FSM_Allocator.Memory;
      end record;
   ...
   function Uninitialized (Ctx : Context) return Boolean is
     (not Unsubscribe.Packet.Has_Buffer (Ctx.P.Outgoing_Ctx)
      ...
      and Session.Unsubscribing.FSM_Allocator.Uninitialized (Ctx.P.Slots));
   ...
   function Global_Allocated (Ctx : Context) return Boolean is
     (Session.Unsubscribing.FSM_Allocator.Global_Allocated (Ctx.P.Slots));
