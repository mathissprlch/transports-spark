...
package body RFLX.Pingresp.Packet
with
  SPARK_Mode
is
   ...
   with
     Pre =>
       ...
       and RFLX.Pingresp.Packet.Valid_Next (Ctx, Fld);
   ...
   with
     Pre =>
       ...
       and then RFLX.Pingresp.Packet.Sufficient_Buffer_Length (Ctx, Fld)
   is
   ...
   with
     Pre =>
       ...
       and then RFLX.Pingresp.Packet.Valid_Size (Ctx, Fld, Size)
       and then Size <= RFLX.Pingresp.Packet.Available_Space (Ctx, Fld)
   ...
   with
     Pre =>
       ...
       and then RFLX.Pingresp.Packet.Valid_Value (Fld, Val)
       and then RFLX.Pingresp.Packet.Valid_Size (Ctx, Fld, RFLX.Pingresp.Packet.Field_Size (Ctx, Fld))
       and then RFLX.Pingresp.Packet.Available_Space (Ctx, Fld) >= RFLX.Pingresp.Packet.Field_Size (Ctx, Fld)
       and then RFLX.Pingresp.Packet.Field_Size (Ctx, Fld) in 1 .. RFLX_Types.Base_Integer'Size
       and then RFLX_Types.Fits_Into (Val, Natural (RFLX.Pingresp.Packet.Field_Size (Ctx, Fld))),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, Fld)
   ...
   procedure Set_Reserved (Ctx : in out Context; Val : RFLX.Pingresp.Reserved_Flags) is
   begin
      Set_Scalar (Ctx, F_Reserved, RFLX.Pingresp.To_Base_Integer (Val));
   end Set_Reserved;

   procedure Set_Remaining_Length (Ctx : in out Context; Val : RFLX.Pingresp.Remaining_Length) is
   begin
      Set_Scalar (Ctx, F_Remaining_Length, RFLX.Pingresp.To_Base_Integer (Val));
