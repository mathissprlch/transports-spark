...
is
   ...
   with
     Pre =>
       not Ctx'Constrained
       and RFLX.Pingresp.Packet.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       RFLX.Pingresp.Packet.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       RFLX.Pingresp.Packet.Has_Buffer (Ctx)
       and then RFLX.Pingresp.Packet.Well_Formed_Message (Ctx)
       and then RFLX.Pingresp.Packet.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Pingresp.Packet.Has_Buffer (Ctx)
       and then Offset < RFLX.Pingresp.Packet.Buffer_Length (Ctx)
       and then Pre (RFLX.Pingresp.Packet.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       RFLX.Pingresp.Packet.Has_Buffer (Ctx)
       and then RFLX.Pingresp.Packet.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.Pingresp.Packet.Byte_Size (Ctx);
   ...
   with
     Pre =>
       RFLX.Pingresp.Packet.Has_Buffer (Ctx)
       and then RFLX.Pingresp.Packet.Valid_Value (Fld, Val)
       and then RFLX.Pingresp.Packet.Valid_Next (Ctx, Fld)
       and then RFLX.Pingresp.Packet.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       RFLX.Pingresp.Packet.Valid_Next (Ctx, Fld);
   ...
   with
     Pre =>
       RFLX.Pingresp.Packet.Valid (Ctx, RFLX.Pingresp.Packet.F_Packet_Type);

   function Get_Reserved (Ctx : Context) return RFLX.Pingresp.Reserved_Flags
   with
     Pre =>
       RFLX.Pingresp.Packet.Valid (Ctx, RFLX.Pingresp.Packet.F_Reserved);

   function Get_Remaining_Length (Ctx : Context) return RFLX.Pingresp.Remaining_Length
   with
     Pre =>
       RFLX.Pingresp.Packet.Valid (Ctx, RFLX.Pingresp.Packet.F_Remaining_Length);
   ...
   with
     ...
     Pre =>
       not Ctx'Constrained
       and then RFLX.Pingresp.Packet.Has_Buffer (Ctx)
       and then RFLX.Pingresp.Packet.Valid_Next (Ctx, RFLX.Pingresp.Packet.F_Packet_Type)
       and then RFLX.Control_Packet.Valid_Packet_Type (RFLX.Control_Packet.To_Base_Integer (Val))
       and then RFLX.Pingresp.Packet.Available_Space (Ctx, RFLX.Pingresp.Packet.F_Packet_Type) >= RFLX.Pingresp.Packet.Field_Size (Ctx, RFLX.Pingresp.Packet.F_Packet_Type)
       and then RFLX.Pingresp.Packet.Field_Condition (Ctx, RFLX.Pingresp.Packet.F_Packet_Type, RFLX.Control_Packet.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
       ...
       and (if
               RFLX_Types.Base_Integer (To_Base_Integer (Get_Packet_Type (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.Control_Packet.PINGRESP))
            then
   ...
   procedure Set_Reserved (Ctx : in out Context; Val : RFLX.Pingresp.Reserved_Flags)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.Pingresp.Packet.Has_Buffer (Ctx)
       and then RFLX.Pingresp.Packet.Valid_Next (Ctx, RFLX.Pingresp.Packet.F_Reserved)
       and then RFLX.Pingresp.Valid_Reserved_Flags (RFLX.Pingresp.To_Base_Integer (Val))
       and then RFLX.Pingresp.Packet.Available_Space (Ctx, RFLX.Pingresp.Packet.F_Reserved) >= RFLX.Pingresp.Packet.Field_Size (Ctx, RFLX.Pingresp.Packet.F_Reserved)
       and then RFLX.Pingresp.Packet.Field_Condition (Ctx, RFLX.Pingresp.Packet.F_Reserved, RFLX.Pingresp.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Remaining_Length (Ctx : in out Context; Val : RFLX.Pingresp.Remaining_Length)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.Pingresp.Packet.Has_Buffer (Ctx)
       and then RFLX.Pingresp.Packet.Valid_Next (Ctx, RFLX.Pingresp.Packet.F_Remaining_Length)
       and then RFLX.Pingresp.Valid_Remaining_Length (RFLX.Pingresp.To_Base_Integer (Val))
       and then RFLX.Pingresp.Packet.Available_Space (Ctx, RFLX.Pingresp.Packet.F_Remaining_Length) >= RFLX.Pingresp.Packet.Field_Size (Ctx, RFLX.Pingresp.Packet.F_Remaining_Length)
       and then RFLX.Pingresp.Packet.Field_Condition (Ctx, RFLX.Pingresp.Packet.F_Remaining_Length, RFLX.Pingresp.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   type Structure is
      record
         ...
         Reserved : RFLX.Pingresp.Reserved_Flags;
         Remaining_Length : RFLX.Pingresp.Remaining_Length;
      end record;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Pingresp.Packet.Has_Buffer (Ctx)
       and then RFLX.Pingresp.Packet.Valid_Structure (Struct)
       and then RFLX.Pingresp.Packet.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
...
private
      ...
      and then (if
                ...
                then
                   (Valid (Cursors (F_Packet_Type))
                    and then RFLX_Types.Base_Integer (Cursors (F_Packet_Type).Value) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.Control_Packet.PINGRESP))))
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then RFLX.Pingresp.Packet.Field_First (Ctx, RFLX.Pingresp.Packet.F_Packet_Type) rem RFLX_Types.Byte'Size = 1
   ...
   function Valid_Value (Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          ...
          when F_Reserved =>
             RFLX.Pingresp.Valid_Reserved_Flags (Val),
          when F_Remaining_Length =>
             RFLX.Pingresp.Valid_Remaining_Length (Val));

   function Field_Condition (Ctx : Context; Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          when F_Packet_Type =>
             Val = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.Control_Packet.PINGRESP)),
   ...
   function Get_Reserved (Ctx : Context) return RFLX.Pingresp.Reserved_Flags is
     (To_Actual (Ctx.Cursors (F_Reserved).Value));

   function Get_Remaining_Length (Ctx : Context) return RFLX.Pingresp.Remaining_Length is
   ...
   function Valid_Structure (Struct : Structure) return Boolean is
     (To_Base_Integer (Struct.Packet_Type) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.Control_Packet.PINGRESP)));
