...
is
   ...
   begin
      ...
      -- crates/mqtt_core/specs/session.rflx:382:10
   ...
   begin
      ...
      -- crates/mqtt_core/specs/session.rflx:393:10
      Unsubscribe.Packet.Verify_Message (Ctx.P.Outgoing_Ctx);
   ...
   begin
      ...
      -- crates/mqtt_core/specs/session.rflx:406:16
      T_3 := Control_Packet.Incoming_Packet.Well_Formed_Message (Ctx.P.Inbound_Ctx);
      -- crates/mqtt_core/specs/session.rflx:407:20
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      -- crates/mqtt_core/specs/session.rflx:409:16
      T_6 := Control_Packet.Incoming_Packet.Well_Formed_Message (Ctx.P.Inbound_Ctx);
      -- crates/mqtt_core/specs/session.rflx:410:21
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      T_20 := T_17
      or else T_19;
      -- crates/mqtt_core/specs/session.rflx:415:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
   ...
   begin
      ...
      -- crates/mqtt_core/specs/session.rflx:423:10
      Control_Packet.Incoming_Packet.Verify_Message (Ctx.P.Inbound_Ctx);
      Ctx.P.Next_State := S_Awaiting_Unsuback;
      pragma Assert (Forwarding_Inbound_Publish_Invariant);
   ...
   begin
      ...
      -- crates/mqtt_core/specs/session.rflx:430:10
      Control_Packet.Incoming_Packet.Verify_Message (Ctx.P.Inbound_Ctx);
      Ctx.P.Next_State := S_Final;
      pragma Assert (Forwarding_Unsuback_Invariant);
