...
package body RFLX.Session.Broker_Reading.FSM
with
  SPARK_Mode
is
   ...
   procedure Awaiting_Connect (Ctx : in out Context)
   with
     Pre =>
       Initialized (Ctx),
     Post =>
   ...
   is
      ...
      T_2 : Boolean;
      function Awaiting_Connect_Invariant return Boolean is
        (True)
      with
        Annotate =>
        ...
        Ghost;
   begin
      pragma Assert (Awaiting_Connect_Invariant);
      -- crates/mqtt_core/specs/session.rflx:587:10
      Control_Packet.Incoming_Packet.Verify_Message (Ctx.P.Inbound_Ctx);
      -- crates/mqtt_core/specs/session.rflx:590:16
      T_0 := Control_Packet.Incoming_Packet.Well_Formed_Message (Ctx.P.Inbound_Ctx);
      -- crates/mqtt_core/specs/session.rflx:591:20
      ...
      if not Control_Packet.Incoming_Packet.Valid (Ctx.P.Inbound_Ctx, Control_Packet.Incoming_Packet.F_Packet_Type) then
         ...
         pragma Assert (Awaiting_Connect_Invariant);
         goto Finalize_Awaiting_Connect;
      end if;
      ...
      -- crates/mqtt_core/specs/session.rflx:591:20
      T_2 := T_1 = Control_Packet.CONNECT;
      if
         T_0
         and then T_2
      then
         Ctx.P.Next_State := S_Forwarding_Connect;
      else
         Ctx.P.Next_State := S_Final;
      end if;
      pragma Assert (Awaiting_Connect_Invariant);
      <<Finalize_Awaiting_Connect>>
   end Awaiting_Connect;

   procedure Forwarding_Connect (Ctx : in out Context)
   with
     Pre =>
       Initialized (Ctx),
     Post =>
       Initialized (Ctx)
   is
      function Forwarding_Connect_Invariant return Boolean is
        (True)
      with
        Annotate =>
          (GNATprove, Inline_For_Proof),
        Ghost;
   begin
      pragma Assert (Forwarding_Connect_Invariant);
      -- crates/mqtt_core/specs/session.rflx:599:10
      Control_Packet.Incoming_Packet.Verify_Message (Ctx.P.Inbound_Ctx);
      Ctx.P.Next_State := S_Reading;
      pragma Assert (Forwarding_Connect_Invariant);
   end Forwarding_Connect;
   ...
   is
      ...
      T_22 : Boolean;
      T_23 : Boolean;
      T_24 : Control_Packet.Packet_Type;
      T_25 : Boolean;
      T_26 : Boolean;
      T_27 : Control_Packet.Packet_Type;
      T_28 : Boolean;
      T_29 : Boolean;
   ...
   begin
      ...
      -- crates/mqtt_core/specs/session.rflx:610:10
      Control_Packet.Incoming_Packet.Verify_Message (Ctx.P.Inbound_Ctx);
      -- crates/mqtt_core/specs/session.rflx:613:16
      T_3 := Control_Packet.Incoming_Packet.Well_Formed_Message (Ctx.P.Inbound_Ctx);
      -- crates/mqtt_core/specs/session.rflx:614:21
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      -- crates/mqtt_core/specs/session.rflx:615:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      T_8 := T_5
      or else T_7;
      -- crates/mqtt_core/specs/session.rflx:616:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      T_11 := T_8
      or else T_10;
      -- crates/mqtt_core/specs/session.rflx:617:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      T_14 := T_11
      or else T_13;
      -- crates/mqtt_core/specs/session.rflx:618:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      T_17 := T_14
      or else T_16;
      -- crates/mqtt_core/specs/session.rflx:619:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      -- crates/mqtt_core/specs/session.rflx:619:24
      T_19 := T_18 = Control_Packet.SUBSCRIBE;
      -- crates/mqtt_core/specs/session.rflx:614:21
      T_20 := T_17
      or else T_19;
      -- crates/mqtt_core/specs/session.rflx:620:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      -- crates/mqtt_core/specs/session.rflx:620:24
      T_22 := T_21 = Control_Packet.UNSUBSCRIBE;
      -- crates/mqtt_core/specs/session.rflx:614:21
      T_23 := T_20
      or else T_22;
      -- crates/mqtt_core/specs/session.rflx:621:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      pragma Warnings (On, "condition can only be False if invalid values present");
      -- crates/mqtt_core/specs/session.rflx:621:24
      T_24 := Control_Packet.Incoming_Packet.Get_Packet_Type (Ctx.P.Inbound_Ctx);
      -- crates/mqtt_core/specs/session.rflx:621:24
      T_25 := T_24 = Control_Packet.PINGREQ;
      -- crates/mqtt_core/specs/session.rflx:614:21
      T_26 := T_23
      or else T_25;
      -- crates/mqtt_core/specs/session.rflx:622:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      pragma Warnings (On, "condition can only be False if invalid values present");
      -- crates/mqtt_core/specs/session.rflx:622:24
      T_27 := Control_Packet.Incoming_Packet.Get_Packet_Type (Ctx.P.Inbound_Ctx);
      -- crates/mqtt_core/specs/session.rflx:622:24
      T_28 := T_27 = Control_Packet.DISCONNECT;
      -- crates/mqtt_core/specs/session.rflx:614:21
      T_29 := T_26
      or else T_28;
      if
   ...
   procedure Forwarding (Ctx : in out Context)
   with
     Pre =>
       Initialized (Ctx),
     Post =>
       Initialized (Ctx)
   is
      function Forwarding_Invariant return Boolean is
        (True)
      with
        Annotate =>
          (GNATprove, Inline_For_Proof),
        Ghost;
   begin
      pragma Assert (Forwarding_Invariant);
      -- crates/mqtt_core/specs/session.rflx:630:10
      Control_Packet.Incoming_Packet.Verify_Message (Ctx.P.Inbound_Ctx);
      Ctx.P.Next_State := S_Reading;
      pragma Assert (Forwarding_Invariant);
   end Forwarding;

   procedure Initialize (Ctx : in out Context; Inbound_Buffer : in out RFLX_Types.Bytes_Ptr) is
   begin
      Control_Packet.Incoming_Packet.Initialize (Ctx.P.Inbound_Ctx, Inbound_Buffer);
      Inbound_Buffer := null;
      Ctx.P.Next_State := S_Awaiting_Connect;
   end Initialize;

   procedure Finalize (Ctx : in out Context; Inbound_Buffer : in out RFLX_Types.Bytes_Ptr) is
   begin
   ...
   begin
      case Ctx.P.Next_State is
         when S_Awaiting_Connect =>
            Awaiting_Connect (Ctx);
         when S_Forwarding_Connect =>
            Forwarding_Connect (Ctx);
         when S_Reading =>
            Reading (Ctx);
         when S_Forwarding =>
            Forwarding (Ctx);
   ...
   function In_IO_State (Ctx : Context) return Boolean is
     (Ctx.P.Next_State in S_Awaiting_Connect | S_Forwarding_Connect | S_Reading | S_Forwarding);
   ...
   begin
      ...
      case Chan is
         ...
         when C_App_Pending =>
            case Ctx.P.Next_State is
               when S_Forwarding_Connect | S_Forwarding =>
   ...
   begin
      case Chan is
         when C_Network =>
            case Ctx.P.Next_State is
               when S_Awaiting_Connect | S_Reading =>
...
end RFLX.Session.Broker_Reading.FSM;
