...
package RFLX.Control_Packet.UTF8_String
with
  SPARK_Mode,
  Always_Terminates
is
   ...
   with
     Pre =>
       not Ctx'Constrained
       and RFLX.Control_Packet.UTF8_String.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       RFLX.Control_Packet.UTF8_String.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       RFLX.Control_Packet.UTF8_String.Has_Buffer (Ctx)
       and then RFLX.Control_Packet.UTF8_String.Well_Formed_Message (Ctx)
       and then RFLX.Control_Packet.UTF8_String.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Control_Packet.UTF8_String.Has_Buffer (Ctx)
       and then Offset < RFLX.Control_Packet.UTF8_String.Buffer_Length (Ctx)
       and then Pre (RFLX.Control_Packet.UTF8_String.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       RFLX.Control_Packet.UTF8_String.Has_Buffer (Ctx)
       and then RFLX.Control_Packet.UTF8_String.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.Control_Packet.UTF8_String.Byte_Size (Ctx);
   ...
   with
     Pre =>
       RFLX.Control_Packet.UTF8_String.Has_Buffer (Ctx)
       and then RFLX.Control_Packet.UTF8_String.Valid_Next (Ctx, Fld)
       and then RFLX.Control_Packet.UTF8_String.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       RFLX.Control_Packet.UTF8_String.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
           when F_Data =>
   ...
   with
     Pre =>
       RFLX.Control_Packet.UTF8_String.Has_Buffer (Ctx)
       and RFLX.Control_Packet.UTF8_String.Valid_Next (Ctx, Fld);
   ...
   function Get_Length (Ctx : Context) return RFLX.Control_Packet.String_Length
   with
     Pre =>
       RFLX.Control_Packet.UTF8_String.Valid (Ctx, RFLX.Control_Packet.UTF8_String.F_Length);
   ...
   with
     ...
     Pre =>
       RFLX.Control_Packet.UTF8_String.Has_Buffer (Ctx)
       and then RFLX.Control_Packet.UTF8_String.Well_Formed (Ctx, RFLX.Control_Packet.UTF8_String.F_Data)
       and then RFLX.Control_Packet.UTF8_String.Valid_Next (Ctx, RFLX.Control_Packet.UTF8_String.F_Data),
     Post =>
   ...
   with
     Pre =>
       ...
       and then RFLX.Control_Packet.UTF8_String.Well_Formed (Ctx, RFLX.Control_Packet.UTF8_String.F_Data)
       and then RFLX.Control_Packet.UTF8_String.Valid_Next (Ctx, RFLX.Control_Packet.UTF8_String.F_Data)
       and then Data'Length = RFLX_Types.To_Length (RFLX.Control_Packet.UTF8_String.Field_Size (Ctx, RFLX.Control_Packet.UTF8_String.F_Data)),
     Post =>
   ...
   with
     Pre =>
       RFLX.Control_Packet.UTF8_String.Has_Buffer (Ctx)
       and RFLX.Control_Packet.UTF8_String.Present (Ctx, RFLX.Control_Packet.UTF8_String.F_Data);
   ...
   procedure Set_Length (Ctx : in out Context; Val : RFLX.Control_Packet.String_Length)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.Control_Packet.UTF8_String.Has_Buffer (Ctx)
       and then RFLX.Control_Packet.UTF8_String.Valid_Next (Ctx, RFLX.Control_Packet.UTF8_String.F_Length)
       and then RFLX.Control_Packet.Valid_String_Length (RFLX.Control_Packet.To_Base_Integer (Val))
       and then RFLX.Control_Packet.UTF8_String.Available_Space (Ctx, RFLX.Control_Packet.UTF8_String.F_Length) >= RFLX.Control_Packet.UTF8_String.Field_Size (Ctx, RFLX.Control_Packet.UTF8_String.F_Length)
       and then RFLX.Control_Packet.UTF8_String.Field_Condition (Ctx, RFLX.Control_Packet.UTF8_String.F_Length),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then RFLX.Control_Packet.UTF8_String.Has_Buffer (Ctx)
       and then RFLX.Control_Packet.UTF8_String.Valid_Next (Ctx, RFLX.Control_Packet.UTF8_String.F_Data)
       and then RFLX.Control_Packet.UTF8_String.Available_Space (Ctx, RFLX.Control_Packet.UTF8_String.F_Data) >= RFLX.Control_Packet.UTF8_String.Field_Size (Ctx, RFLX.Control_Packet.UTF8_String.F_Data)
       and then RFLX.Control_Packet.UTF8_String.Field_Condition (Ctx, RFLX.Control_Packet.UTF8_String.F_Data)
       and then RFLX.Control_Packet.UTF8_String.Field_Size (Ctx, RFLX.Control_Packet.UTF8_String.F_Data) = 0,
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then RFLX.Control_Packet.UTF8_String.Valid_Next (Ctx, RFLX.Control_Packet.UTF8_String.F_Data)
       and then RFLX.Control_Packet.UTF8_String.Available_Space (Ctx, RFLX.Control_Packet.UTF8_String.F_Data) >= RFLX.Control_Packet.UTF8_String.Field_Size (Ctx, RFLX.Control_Packet.UTF8_String.F_Data)
       and then RFLX.Control_Packet.UTF8_String.Valid_Length (Ctx, RFLX.Control_Packet.UTF8_String.F_Data, Data'Length)
       and then RFLX.Control_Packet.UTF8_String.Available_Space (Ctx, RFLX.Control_Packet.UTF8_String.F_Data) >= Data'Length * RFLX_Types.Byte'Size
       and then RFLX.Control_Packet.UTF8_String.Field_Condition (Ctx, RFLX.Control_Packet.UTF8_String.F_Data),
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Data)
   ...
   with
     Pre =>
       ...
       and then RFLX.Control_Packet.UTF8_String.Valid_Next (Ctx, RFLX.Control_Packet.UTF8_String.F_Data)
       and then RFLX.Control_Packet.UTF8_String.Available_Space (Ctx, RFLX.Control_Packet.UTF8_String.F_Data) >= RFLX.Control_Packet.UTF8_String.Field_Size (Ctx, RFLX.Control_Packet.UTF8_String.F_Data)
       and then RFLX.Control_Packet.UTF8_String.Valid_Length (Ctx, RFLX.Control_Packet.UTF8_String.F_Data, Length)
       and then RFLX_Types.To_Length (RFLX.Control_Packet.UTF8_String.Available_Space (Ctx, RFLX.Control_Packet.UTF8_String.F_Data)) >= Length
   ...
   type Structure is
      record
         Length : RFLX.Control_Packet.String_Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Control_Packet.UTF8_String.Has_Buffer (Ctx)
       and then RFLX.Control_Packet.UTF8_String.Valid_Structure (Struct)
       and then RFLX.Control_Packet.UTF8_String.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
...
private
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then RFLX.Control_Packet.UTF8_String.Field_First (Ctx, RFLX.Control_Packet.UTF8_String.F_Length) rem RFLX_Types.Byte'Size = 1
   ...
   function Get_Length (Ctx : Context) return RFLX.Control_Packet.String_Length is
...
end RFLX.Control_Packet.UTF8_String;
