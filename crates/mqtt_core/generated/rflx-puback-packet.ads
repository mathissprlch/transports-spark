...
is
   ...
   with
     Pre =>
       not Ctx'Constrained
       and RFLX.Puback.Packet.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       RFLX.Puback.Packet.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       RFLX.Puback.Packet.Has_Buffer (Ctx)
       and then RFLX.Puback.Packet.Well_Formed_Message (Ctx)
       and then RFLX.Puback.Packet.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Puback.Packet.Has_Buffer (Ctx)
       and then Offset < RFLX.Puback.Packet.Buffer_Length (Ctx)
       and then Pre (RFLX.Puback.Packet.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       RFLX.Puback.Packet.Has_Buffer (Ctx)
       and then RFLX.Puback.Packet.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.Puback.Packet.Byte_Size (Ctx);
   ...
   with
     Pre =>
       RFLX.Puback.Packet.Has_Buffer (Ctx)
       and then RFLX.Puback.Packet.Valid_Value (Fld, Val)
       and then RFLX.Puback.Packet.Valid_Next (Ctx, Fld)
       and then RFLX.Puback.Packet.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       RFLX.Puback.Packet.Valid_Next (Ctx, Fld);
   ...
   with
     Pre =>
       RFLX.Puback.Packet.Valid (Ctx, RFLX.Puback.Packet.F_Packet_Type);

   function Get_Reserved (Ctx : Context) return RFLX.Puback.Reserved_Flags
   with
     Pre =>
       RFLX.Puback.Packet.Valid (Ctx, RFLX.Puback.Packet.F_Reserved);

   function Get_Remaining_Length (Ctx : Context) return RFLX.Puback.Remaining_Length
   with
     Pre =>
       RFLX.Puback.Packet.Valid (Ctx, RFLX.Puback.Packet.F_Remaining_Length);

   function Get_Packet_Identifier (Ctx : Context) return RFLX.Control_Packet.Packet_Identifier
   with
     Pre =>
       RFLX.Puback.Packet.Valid (Ctx, RFLX.Puback.Packet.F_Packet_Identifier);
   ...
   with
     ...
     Pre =>
       not Ctx'Constrained
       and then RFLX.Puback.Packet.Has_Buffer (Ctx)
       and then RFLX.Puback.Packet.Valid_Next (Ctx, RFLX.Puback.Packet.F_Packet_Type)
       and then RFLX.Control_Packet.Valid_Packet_Type (RFLX.Control_Packet.To_Base_Integer (Val))
       and then RFLX.Puback.Packet.Available_Space (Ctx, RFLX.Puback.Packet.F_Packet_Type) >= RFLX.Puback.Packet.Field_Size (Ctx, RFLX.Puback.Packet.F_Packet_Type)
       and then RFLX.Puback.Packet.Field_Condition (Ctx, RFLX.Puback.Packet.F_Packet_Type, RFLX.Control_Packet.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
       ...
       and (if
               RFLX_Types.Base_Integer (To_Base_Integer (Get_Packet_Type (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.Control_Packet.PUBACK))
            then
   ...
   procedure Set_Reserved (Ctx : in out Context; Val : RFLX.Puback.Reserved_Flags)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.Puback.Packet.Has_Buffer (Ctx)
       and then RFLX.Puback.Packet.Valid_Next (Ctx, RFLX.Puback.Packet.F_Reserved)
       and then RFLX.Puback.Valid_Reserved_Flags (RFLX.Puback.To_Base_Integer (Val))
       and then RFLX.Puback.Packet.Available_Space (Ctx, RFLX.Puback.Packet.F_Reserved) >= RFLX.Puback.Packet.Field_Size (Ctx, RFLX.Puback.Packet.F_Reserved)
       and then RFLX.Puback.Packet.Field_Condition (Ctx, RFLX.Puback.Packet.F_Reserved, RFLX.Puback.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Remaining_Length (Ctx : in out Context; Val : RFLX.Puback.Remaining_Length)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.Puback.Packet.Has_Buffer (Ctx)
       and then RFLX.Puback.Packet.Valid_Next (Ctx, RFLX.Puback.Packet.F_Remaining_Length)
       and then RFLX.Puback.Valid_Remaining_Length (RFLX.Puback.To_Base_Integer (Val))
       and then RFLX.Puback.Packet.Available_Space (Ctx, RFLX.Puback.Packet.F_Remaining_Length) >= RFLX.Puback.Packet.Field_Size (Ctx, RFLX.Puback.Packet.F_Remaining_Length)
       and then RFLX.Puback.Packet.Field_Condition (Ctx, RFLX.Puback.Packet.F_Remaining_Length, RFLX.Puback.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     ...
     Pre =>
       not Ctx'Constrained
       and then RFLX.Puback.Packet.Has_Buffer (Ctx)
       and then RFLX.Puback.Packet.Valid_Next (Ctx, RFLX.Puback.Packet.F_Packet_Identifier)
       and then RFLX.Control_Packet.Valid_Packet_Identifier (RFLX.Control_Packet.To_Base_Integer (Val))
       and then RFLX.Puback.Packet.Available_Space (Ctx, RFLX.Puback.Packet.F_Packet_Identifier) >= RFLX.Puback.Packet.Field_Size (Ctx, RFLX.Puback.Packet.F_Packet_Identifier)
       and then RFLX.Puback.Packet.Field_Condition (Ctx, RFLX.Puback.Packet.F_Packet_Identifier, RFLX.Control_Packet.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   type Structure is
      record
         ...
         Reserved : RFLX.Puback.Reserved_Flags;
         Remaining_Length : RFLX.Puback.Remaining_Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Puback.Packet.Has_Buffer (Ctx)
       and then RFLX.Puback.Packet.Valid_Structure (Struct)
       and then RFLX.Puback.Packet.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
...
private
      ...
      and then (if
                ...
                then
                   (Valid (Cursors (F_Packet_Type))
                    and then RFLX_Types.Base_Integer (Cursors (F_Packet_Type).Value) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.Control_Packet.PUBACK))))
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then RFLX.Puback.Packet.Field_First (Ctx, RFLX.Puback.Packet.F_Packet_Type) rem RFLX_Types.Byte'Size = 1
   ...
   function Valid_Value (Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          ...
          when F_Reserved =>
             RFLX.Puback.Valid_Reserved_Flags (Val),
          when F_Remaining_Length =>
             RFLX.Puback.Valid_Remaining_Length (Val),
          when F_Packet_Identifier =>
   ...
   function Field_Condition (Ctx : Context; Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          when F_Packet_Type =>
             Val = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.Control_Packet.PUBACK)),
   ...
   function Get_Reserved (Ctx : Context) return RFLX.Puback.Reserved_Flags is
     (To_Actual (Ctx.Cursors (F_Reserved).Value));

   function Get_Remaining_Length (Ctx : Context) return RFLX.Puback.Remaining_Length is
   ...
   function Valid_Structure (Struct : Structure) return Boolean is
     (To_Base_Integer (Struct.Packet_Type) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.Control_Packet.PUBACK)));
