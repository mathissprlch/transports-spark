...
is
   ...
   type Virtual_Field is (F_Initial, F_Packet_Type, F_Reserved, F_Remaining_Length, F_Packet_Identifier, F_Final);

   subtype Field is Virtual_Field range F_Packet_Type .. F_Packet_Identifier;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and RFLX.Unsuback.Packet.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       RFLX.Unsuback.Packet.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       RFLX.Unsuback.Packet.Has_Buffer (Ctx)
       and then RFLX.Unsuback.Packet.Well_Formed_Message (Ctx)
       and then RFLX.Unsuback.Packet.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Unsuback.Packet.Has_Buffer (Ctx)
       and then Offset < RFLX.Unsuback.Packet.Buffer_Length (Ctx)
       and then Pre (RFLX.Unsuback.Packet.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       RFLX.Unsuback.Packet.Has_Buffer (Ctx)
       and then RFLX.Unsuback.Packet.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.Unsuback.Packet.Byte_Size (Ctx);
   ...
   with
     Pre =>
       RFLX.Unsuback.Packet.Has_Buffer (Ctx)
       and then RFLX.Unsuback.Packet.Valid_Value (Fld, Val)
       and then RFLX.Unsuback.Packet.Valid_Next (Ctx, Fld)
       and then RFLX.Unsuback.Packet.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       RFLX.Unsuback.Packet.Valid_Next (Ctx, Fld);
   ...
   with
     Pre =>
       RFLX.Unsuback.Packet.Valid (Ctx, RFLX.Unsuback.Packet.F_Packet_Type);

   function Get_Reserved (Ctx : Context) return RFLX.Unsuback.Reserved_Flags
   with
     Pre =>
       RFLX.Unsuback.Packet.Valid (Ctx, RFLX.Unsuback.Packet.F_Reserved);

   function Get_Remaining_Length (Ctx : Context) return RFLX.Unsuback.Remaining_Length
   with
     Pre =>
       RFLX.Unsuback.Packet.Valid (Ctx, RFLX.Unsuback.Packet.F_Remaining_Length);

   function Get_Packet_Identifier (Ctx : Context) return RFLX.Control_Packet.Packet_Identifier
   with
     Pre =>
       RFLX.Unsuback.Packet.Valid (Ctx, RFLX.Unsuback.Packet.F_Packet_Identifier);
   ...
   with
     ...
     Pre =>
       not Ctx'Constrained
       and then RFLX.Unsuback.Packet.Has_Buffer (Ctx)
       and then RFLX.Unsuback.Packet.Valid_Next (Ctx, RFLX.Unsuback.Packet.F_Packet_Type)
       and then RFLX.Control_Packet.Valid_Packet_Type (RFLX.Control_Packet.To_Base_Integer (Val))
       and then RFLX.Unsuback.Packet.Available_Space (Ctx, RFLX.Unsuback.Packet.F_Packet_Type) >= RFLX.Unsuback.Packet.Field_Size (Ctx, RFLX.Unsuback.Packet.F_Packet_Type)
       and then RFLX.Unsuback.Packet.Field_Condition (Ctx, RFLX.Unsuback.Packet.F_Packet_Type, RFLX.Control_Packet.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
       ...
       and (if
               RFLX_Types.Base_Integer (To_Base_Integer (Get_Packet_Type (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.Control_Packet.UNSUBACK))
            then
   ...
   procedure Set_Reserved (Ctx : in out Context; Val : RFLX.Unsuback.Reserved_Flags)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.Unsuback.Packet.Has_Buffer (Ctx)
       and then RFLX.Unsuback.Packet.Valid_Next (Ctx, RFLX.Unsuback.Packet.F_Reserved)
       and then RFLX.Unsuback.Valid_Reserved_Flags (RFLX.Unsuback.To_Base_Integer (Val))
       and then RFLX.Unsuback.Packet.Available_Space (Ctx, RFLX.Unsuback.Packet.F_Reserved) >= RFLX.Unsuback.Packet.Field_Size (Ctx, RFLX.Unsuback.Packet.F_Reserved)
       and then RFLX.Unsuback.Packet.Field_Condition (Ctx, RFLX.Unsuback.Packet.F_Reserved, RFLX.Unsuback.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Remaining_Length (Ctx : in out Context; Val : RFLX.Unsuback.Remaining_Length)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.Unsuback.Packet.Has_Buffer (Ctx)
       and then RFLX.Unsuback.Packet.Valid_Next (Ctx, RFLX.Unsuback.Packet.F_Remaining_Length)
       and then RFLX.Unsuback.Valid_Remaining_Length (RFLX.Unsuback.To_Base_Integer (Val))
       and then RFLX.Unsuback.Packet.Available_Space (Ctx, RFLX.Unsuback.Packet.F_Remaining_Length) >= RFLX.Unsuback.Packet.Field_Size (Ctx, RFLX.Unsuback.Packet.F_Remaining_Length)
       and then RFLX.Unsuback.Packet.Field_Condition (Ctx, RFLX.Unsuback.Packet.F_Remaining_Length, RFLX.Unsuback.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     ...
     Pre =>
       not Ctx'Constrained
       and then RFLX.Unsuback.Packet.Has_Buffer (Ctx)
       and then RFLX.Unsuback.Packet.Valid_Next (Ctx, RFLX.Unsuback.Packet.F_Packet_Identifier)
       and then RFLX.Control_Packet.Valid_Packet_Identifier (RFLX.Control_Packet.To_Base_Integer (Val))
       and then RFLX.Unsuback.Packet.Available_Space (Ctx, RFLX.Unsuback.Packet.F_Packet_Identifier) >= RFLX.Unsuback.Packet.Field_Size (Ctx, RFLX.Unsuback.Packet.F_Packet_Identifier)
       and then RFLX.Unsuback.Packet.Field_Condition (Ctx, RFLX.Unsuback.Packet.F_Packet_Identifier, RFLX.Control_Packet.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, F_Packet_Identifier)
       and Get_Packet_Identifier (Ctx) = Val
       and (if Well_Formed_Message (Ctx) then Message_Last (Ctx) = Field_Last (Ctx, F_Packet_Identifier))
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and Ctx.First = Ctx.First'Old
       and Ctx.Last = Ctx.Last'Old
   ...
   type Structure is
      record
         ...
         Reserved : RFLX.Unsuback.Reserved_Flags;
         Remaining_Length : RFLX.Unsuback.Remaining_Length;
         Packet_Identifier : RFLX.Control_Packet.Packet_Identifier;
      end record;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Unsuback.Packet.Has_Buffer (Ctx)
       and then RFLX.Unsuback.Packet.Valid_Structure (Struct)
       and then RFLX.Unsuback.Packet.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
   ...
   function Field_Size_Packet_Identifier (Struct : Structure) return RFLX_Types.Bit_Length
   with
     Pre =>
       Valid_Structure (Struct);
...
private
      ...
      and then (if
                ...
                then
                   (Valid (Cursors (F_Packet_Type))
                    and then RFLX_Types.Base_Integer (Cursors (F_Packet_Type).Value) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.Control_Packet.UNSUBACK))))
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then RFLX.Unsuback.Packet.Field_First (Ctx, RFLX.Unsuback.Packet.F_Packet_Type) rem RFLX_Types.Byte'Size = 1
   ...
   function Valid_Value (Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          ...
          when F_Reserved =>
             RFLX.Unsuback.Valid_Reserved_Flags (Val),
          when F_Remaining_Length =>
             RFLX.Unsuback.Valid_Remaining_Length (Val),
          when F_Packet_Identifier =>
   ...
   function Field_Condition (Ctx : Context; Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          when F_Packet_Type =>
             Val = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.Control_Packet.UNSUBACK)),
          when F_Reserved | F_Remaining_Length | F_Packet_Identifier =>
             True);
   ...
   function Get_Reserved (Ctx : Context) return RFLX.Unsuback.Reserved_Flags is
     (To_Actual (Ctx.Cursors (F_Reserved).Value));

   function Get_Remaining_Length (Ctx : Context) return RFLX.Unsuback.Remaining_Length is
   ...
   function Valid_Structure (Struct : Structure) return Boolean is
     (To_Base_Integer (Struct.Packet_Type) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.Control_Packet.UNSUBACK)));
   ...
   function Field_Size_Packet_Identifier (Struct : Structure) return RFLX_Types.Bit_Length is
     (16);

end RFLX.Unsuback.Packet;
