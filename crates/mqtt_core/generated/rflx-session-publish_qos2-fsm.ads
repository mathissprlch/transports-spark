...
with RFLX.Session.Publish_Qos2.FSM_Allocator;
...
private
   ...
   type Private_Context is
      record
         ...
         Slots : Session.Publish_Qos2.FSM_Allocator.Slots;
         Memory : Session.Publish_Qos2.FSM_Allocator.Memory;
      end record;
   ...
   function Uninitialized (Ctx : Context) return Boolean is
     (not Publish.Packet.Has_Buffer (Ctx.P.Outgoing_Ctx)
      ...
      and Session.Publish_Qos2.FSM_Allocator.Uninitialized (Ctx.P.Slots));
   ...
   function Global_Allocated (Ctx : Context) return Boolean is
     (Session.Publish_Qos2.FSM_Allocator.Global_Allocated (Ctx.P.Slots));
