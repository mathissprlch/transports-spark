...
is
   ...
   begin
      ...
      -- crates/mqtt_core/specs/session.rflx:106:10
   ...
   begin
      ...
      -- crates/mqtt_core/specs/session.rflx:130:16
      T_3 := Control_Packet.Incoming_Packet.Well_Formed_Message (Ctx.P.Inbound_Ctx);
      -- crates/mqtt_core/specs/session.rflx:131:21
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      -- crates/mqtt_core/specs/session.rflx:132:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      -- crates/mqtt_core/specs/session.rflx:132:24
      T_7 := T_6 = Control_Packet.PINGRESP;
      -- crates/mqtt_core/specs/session.rflx:131:21
      T_8 := T_5
      or else T_7;
      -- crates/mqtt_core/specs/session.rflx:133:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      T_11 := T_8
      or else T_10;
      -- crates/mqtt_core/specs/session.rflx:134:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      T_14 := T_11
      or else T_13;
      -- crates/mqtt_core/specs/session.rflx:135:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      T_17 := T_14
      or else T_16;
      -- crates/mqtt_core/specs/session.rflx:136:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      T_20 := T_17
      or else T_19;
      -- crates/mqtt_core/specs/session.rflx:137:24
      pragma Warnings (Off, "condition can only be False if invalid values present");
      pragma Warnings (Off, "condition is always False");
      pragma Warnings (Off, "this code can never be executed and has been deleted");
      pragma Warnings (Off, "statement has no effect");
      ...
      if
         ...
         and then T_2
      then
         Ctx.P.Next_State := S_Validating_Puback;
      elsif
         T_3
         and then T_23
      then
   ...
   procedure Validating_Puback (Ctx : in out Context)
   with
     Pre =>
       Initialized (Ctx),
     Post =>
       Initialized (Ctx)
   is
      function Validating_Puback_Invariant return Boolean is
        (Ctx.P.Slots.Slot_Ptr_1 = null
         and Ctx.P.Slots.Slot_Ptr_2 = null
         and Ctx.P.Slots.Slot_Ptr_3 = null)
      with
        ...
        Ghost;
   begin
      pragma Assert (Validating_Puback_Invariant);
      -- crates/mqtt_core/specs/session.rflx:150:10
      Puback.Packet.Verify_Message (Ctx.P.Inbound_Puback_Ctx);
      Ctx.P.Next_State := S_Final;
      pragma Assert (Validating_Puback_Invariant);
   ...
   procedure Initialize (Ctx : in out Context) is
      ...
      Inbound_Puback_Buffer : RFLX_Types.Bytes_Ptr;
   begin
      Session.Publish_Qos1.FSM_Allocator.Initialize (Ctx.P.Slots, Ctx.P.Memory);
      ...
      Inbound_Puback_Buffer := Ctx.P.Slots.Slot_Ptr_3;
      pragma Warnings (Off, "unused assignment");
      Ctx.P.Slots.Slot_Ptr_3 := null;
      pragma Warnings (On, "unused assignment");
      Puback.Packet.Initialize (Ctx.P.Inbound_Puback_Ctx, Inbound_Puback_Buffer);
   ...
   begin
      ...
      pragma Assert (Ctx.P.Slots.Slot_Ptr_2 /= null);
      pragma Warnings (Off, """Ctx.P.Inbound_Puback_Ctx"" is set by ""Take_Buffer"" but not used after the call");
      Puback.Packet.Take_Buffer (Ctx.P.Inbound_Puback_Ctx, Inbound_Puback_Buffer);
      pragma Warnings (On, """Ctx.P.Inbound_Puback_Ctx"" is set by ""Take_Buffer"" but not used after the call");
      pragma Assert (Ctx.P.Slots.Slot_Ptr_3 = null);
      pragma Assert (Inbound_Puback_Buffer /= null);
      Ctx.P.Slots.Slot_Ptr_3 := Inbound_Puback_Buffer;
      pragma Assert (Ctx.P.Slots.Slot_Ptr_3 /= null);
      Session.Publish_Qos1.FSM_Allocator.Finalize (Ctx.P.Slots);
      Ctx.P.Next_State := S_Final;
   end Finalize;
   ...
   begin
      case Ctx.P.Next_State is
         ...
         when S_Validating_Puback =>
            Puback.Packet.Reset (Ctx.P.Inbound_Puback_Ctx, Ctx.P.Inbound_Puback_Ctx.First, Ctx.P.Inbound_Puback_Ctx.First - 1);
         when S_Final =>
            null;
      end case;
   ...
   function In_IO_State (Ctx : Context) return Boolean is
     (Ctx.P.Next_State in S_Sending | S_Awaiting_Puback | S_Validating_Puback);
   ...
   procedure Write (Ctx : in out Context; Chan : Channel; Buffer : RFLX_Types.Bytes; Offset : RFLX_Types.Length := 0) is
      ...
      procedure Puback_Packet_Write is new Puback.Packet.Generic_Write (Write, Write_Pre);
   begin
      case Chan is
         when C_Network =>
            case Ctx.P.Next_State is
               ...
               when S_Validating_Puback =>
                  Puback_Packet_Write (Ctx.P.Inbound_Puback_Ctx, Offset);
               when others =>
                  pragma Warnings (Off, "unreachable code");
                  null;
                  pragma Warnings (On, "unreachable code");
