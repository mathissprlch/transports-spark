...
is
   ...
   begin
      ...
      -- crates/mqtt_core/specs/session.rflx:67:10
   ...
   begin
      ...
      -- crates/mqtt_core/specs/session.rflx:78:10
      Connect.Packet.Verify_Message (Ctx.P.Outgoing_Ctx);
   ...
   begin
      ...
      -- crates/mqtt_core/specs/session.rflx:99:10
      Control_Packet.Incoming_Packet.Verify_Message (Ctx.P.Inbound_Ctx);
      Ctx.P.Next_State := S_Final;
      pragma Assert (Forwarding_Connack_Invariant);
   ...
   begin
      case Ext_Buf is
         ...
         when B_Outgoing =>
            Connect.Packet.Initialize (Ctx.P.Outgoing_Ctx, Buffer, Written_Last => Written_Last);
      end case;
      Buffer := null;
   end Add_Buffer;
   ...
   begin
      case Ext_Buf is
         ...
         when B_Outgoing =>
            pragma Warnings (Off, """Ctx.P.Outgoing_Ctx"" is set by ""Take_Buffer"" but not used after the call");
            Connect.Packet.Take_Buffer (Ctx.P.Outgoing_Ctx, Buffer);
            pragma Warnings (On, """Ctx.P.Outgoing_Ctx"" is set by ""Take_Buffer"" but not used after the call");
      end case;
   end Remove_Buffer;
