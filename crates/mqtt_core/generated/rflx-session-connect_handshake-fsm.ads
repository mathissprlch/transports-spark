...
with RFLX.Session.Connect_Handshake.FSM_Allocator;
...
private
   ...
   type Private_Context is
      record
         ...
         Slots : Session.Connect_Handshake.FSM_Allocator.Slots;
         Memory : Session.Connect_Handshake.FSM_Allocator.Memory;
      end record;
   ...
   function Uninitialized (Ctx : Context) return Boolean is
     (not Connect.Packet.Has_Buffer (Ctx.P.Outgoing_Ctx)
      ...
      and Session.Connect_Handshake.FSM_Allocator.Uninitialized (Ctx.P.Slots));
   ...
   function Global_Allocated (Ctx : Context) return Boolean is
     (Session.Connect_Handshake.FSM_Allocator.Global_Allocated (Ctx.P.Slots));
