...
package RFLX.Control_Packet.Incoming_Packet
with
  SPARK_Mode,
  Always_Terminates
is
   ...
   type Virtual_Field is (F_Initial, F_Packet_Type, F_Flags, F_Remaining_Length, F_Payload, F_Final);
   ...
   with
     Pre =>
       not Ctx'Constrained
       and RFLX.Control_Packet.Incoming_Packet.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       RFLX.Control_Packet.Incoming_Packet.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       RFLX.Control_Packet.Incoming_Packet.Has_Buffer (Ctx)
       and then RFLX.Control_Packet.Incoming_Packet.Well_Formed_Message (Ctx)
       and then RFLX.Control_Packet.Incoming_Packet.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Control_Packet.Incoming_Packet.Has_Buffer (Ctx)
       and then Offset < RFLX.Control_Packet.Incoming_Packet.Buffer_Length (Ctx)
       and then Pre (RFLX.Control_Packet.Incoming_Packet.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       RFLX.Control_Packet.Incoming_Packet.Has_Buffer (Ctx)
       and then RFLX.Control_Packet.Incoming_Packet.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.Control_Packet.Incoming_Packet.Byte_Size (Ctx);
   ...
   with
     Pre =>
       RFLX.Control_Packet.Incoming_Packet.Has_Buffer (Ctx)
       and then RFLX.Control_Packet.Incoming_Packet.Valid_Next (Ctx, Fld)
       and then RFLX.Control_Packet.Incoming_Packet.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       RFLX.Control_Packet.Incoming_Packet.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
           when F_Payload =>
   ...
   with
     Pre =>
       RFLX.Control_Packet.Incoming_Packet.Has_Buffer (Ctx)
       and RFLX.Control_Packet.Incoming_Packet.Valid_Next (Ctx, Fld);
   ...
   with
     Pre =>
       RFLX.Control_Packet.Incoming_Packet.Valid (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Packet_Type);

   function Get_Flags (Ctx : Context) return RFLX.Control_Packet.Header_Flags
   with
     Pre =>
       RFLX.Control_Packet.Incoming_Packet.Valid (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Flags);

   function Get_Remaining_Length (Ctx : Context) return RFLX.Control_Packet.Single_Byte_Remaining_Length
   with
     Pre =>
       RFLX.Control_Packet.Incoming_Packet.Valid (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Remaining_Length);
   ...
   with
     ...
     Pre =>
       RFLX.Control_Packet.Incoming_Packet.Has_Buffer (Ctx)
       and then RFLX.Control_Packet.Incoming_Packet.Well_Formed (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload)
       and then RFLX.Control_Packet.Incoming_Packet.Valid_Next (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload),
     Post =>
   ...
   with
     Pre =>
       ...
       and then RFLX.Control_Packet.Incoming_Packet.Well_Formed (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload)
       and then RFLX.Control_Packet.Incoming_Packet.Valid_Next (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload)
       and then Data'Length = RFLX_Types.To_Length (RFLX.Control_Packet.Incoming_Packet.Field_Size (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload)),
     Post =>
   ...
   with
     Pre =>
       RFLX.Control_Packet.Incoming_Packet.Has_Buffer (Ctx)
       and RFLX.Control_Packet.Incoming_Packet.Present (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload);
   ...
   with
     ...
     Pre =>
       not Ctx'Constrained
       and then RFLX.Control_Packet.Incoming_Packet.Has_Buffer (Ctx)
       and then RFLX.Control_Packet.Incoming_Packet.Valid_Next (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Packet_Type)
       and then RFLX.Control_Packet.Valid_Packet_Type (RFLX.Control_Packet.To_Base_Integer (Val))
       and then RFLX.Control_Packet.Incoming_Packet.Available_Space (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Packet_Type) >= RFLX.Control_Packet.Incoming_Packet.Field_Size (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Packet_Type)
       and then RFLX.Control_Packet.Incoming_Packet.Field_Condition (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Packet_Type),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Flags (Ctx : in out Context; Val : RFLX.Control_Packet.Header_Flags)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.Control_Packet.Incoming_Packet.Has_Buffer (Ctx)
       and then RFLX.Control_Packet.Incoming_Packet.Valid_Next (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Flags)
       and then RFLX.Control_Packet.Valid_Header_Flags (RFLX.Control_Packet.To_Base_Integer (Val))
       and then RFLX.Control_Packet.Incoming_Packet.Available_Space (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Flags) >= RFLX.Control_Packet.Incoming_Packet.Field_Size (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Flags)
       and then RFLX.Control_Packet.Incoming_Packet.Field_Condition (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Flags),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Remaining_Length (Ctx : in out Context; Val : RFLX.Control_Packet.Single_Byte_Remaining_Length)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.Control_Packet.Incoming_Packet.Has_Buffer (Ctx)
       and then RFLX.Control_Packet.Incoming_Packet.Valid_Next (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Remaining_Length)
       and then RFLX.Control_Packet.Valid_Single_Byte_Remaining_Length (RFLX.Control_Packet.To_Base_Integer (Val))
       and then RFLX.Control_Packet.Incoming_Packet.Available_Space (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Remaining_Length) >= RFLX.Control_Packet.Incoming_Packet.Field_Size (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Remaining_Length)
       and then RFLX.Control_Packet.Incoming_Packet.Field_Condition (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Remaining_Length),
     Post =>
       Has_Buffer (Ctx)
       ...
       and (for all F in Field range F_Packet_Type .. F_Flags =>
               Context_Cursors_Index (Context_Cursors (Ctx), F) = Context_Cursors_Index (Context_Cursors (Ctx)'Old, F));
   ...
   with
     Pre =>
       ...
       and then RFLX.Control_Packet.Incoming_Packet.Has_Buffer (Ctx)
       and then RFLX.Control_Packet.Incoming_Packet.Valid_Next (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload)
       and then RFLX.Control_Packet.Incoming_Packet.Available_Space (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload) >= RFLX.Control_Packet.Incoming_Packet.Field_Size (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload)
       and then RFLX.Control_Packet.Incoming_Packet.Field_Condition (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload)
       and then RFLX.Control_Packet.Incoming_Packet.Field_Size (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload) = 0,
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then RFLX.Control_Packet.Incoming_Packet.Valid_Next (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload)
       and then RFLX.Control_Packet.Incoming_Packet.Available_Space (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload) >= RFLX.Control_Packet.Incoming_Packet.Field_Size (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload)
       and then RFLX.Control_Packet.Incoming_Packet.Valid_Length (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload, Data'Length)
       and then RFLX.Control_Packet.Incoming_Packet.Available_Space (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload) >= Data'Length * RFLX_Types.Byte'Size
       and then RFLX.Control_Packet.Incoming_Packet.Field_Condition (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload),
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Payload)
   ...
   with
     Pre =>
       ...
       and then RFLX.Control_Packet.Incoming_Packet.Valid_Next (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload)
       and then RFLX.Control_Packet.Incoming_Packet.Available_Space (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload) >= RFLX.Control_Packet.Incoming_Packet.Field_Size (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload)
       and then RFLX.Control_Packet.Incoming_Packet.Valid_Length (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload, Length)
       and then RFLX_Types.To_Length (RFLX.Control_Packet.Incoming_Packet.Available_Space (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Payload)) >= Length
   ...
   type Structure is
      record
         ...
         Flags : RFLX.Control_Packet.Header_Flags;
         Remaining_Length : RFLX.Control_Packet.Single_Byte_Remaining_Length;
         Payload : RFLX_Types.Bytes (RFLX_Types.Index'First .. RFLX_Types.Index'First + 126);
      end record;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Control_Packet.Incoming_Packet.Has_Buffer (Ctx)
       and then RFLX.Control_Packet.Incoming_Packet.Valid_Structure (Struct)
       and then RFLX.Control_Packet.Incoming_Packet.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
...
private
   ...
   function Valid_Predecessors_Invariant (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return Boolean is
     ((if Well_Formed (Cursors (F_Packet_Type)) then True)
      and then (if Well_Formed (Cursors (F_Flags)) then Valid (Cursors (F_Packet_Type)))
      and then (if Well_Formed (Cursors (F_Remaining_Length)) then Valid (Cursors (F_Flags)))
      and then (if Well_Formed (Cursors (F_Payload)) then Valid (Cursors (F_Remaining_Length))))
   with
     Pre =>
   ...
   function Field_Size_Internal (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Fld : Field) return RFLX_Types.Bit_Length'Base is
     (case Fld is
          when F_Packet_Type | F_Flags =>
             4,
          when F_Remaining_Length =>
             8,
          when F_Payload =>
             RFLX_Types.Bit_Length (Cursors (F_Remaining_Length).Value) * 8)
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
     ...
     ((if
      ...
      and then ((if
                ...
                and then (if
                          ...
                          then
                             (Cursors (F_Flags).Last - Cursors (F_Flags).First + 1 = 4
                              and then Cursors (F_Flags).First = Cursors (F_Packet_Type).Last + 1))
                and then (if
                             Well_Formed (Cursors (F_Remaining_Length))
                          then
                             (Cursors (F_Remaining_Length).Last - Cursors (F_Remaining_Length).First + 1 = 8
                              and then Cursors (F_Remaining_Length).First = Cursors (F_Flags).Last + 1))
                and then (if
                             Well_Formed (Cursors (F_Payload))
                          then
                             (Cursors (F_Payload).Last - Cursors (F_Payload).First + 1 = RFLX_Types.Bit_Length (Cursors (F_Remaining_Length).Value) * 8
                              and then Cursors (F_Payload).First = Cursors (F_Remaining_Length).Last + 1))))
   with
     Post =>
       True;
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then RFLX.Control_Packet.Incoming_Packet.Field_First (Ctx, RFLX.Control_Packet.Incoming_Packet.F_Packet_Type) rem RFLX_Types.Byte'Size = 1
   ...
   function Valid_Value (Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          ...
          when F_Flags =>
             RFLX.Control_Packet.Valid_Header_Flags (Val),
          when F_Remaining_Length =>
             RFLX.Control_Packet.Valid_Single_Byte_Remaining_Length (Val),
          when F_Payload =>
             True);

   function Field_Condition (Ctx : Context; Fld : Field) return Boolean is
     (case Fld is
          when F_Packet_Type | F_Flags | F_Remaining_Length | F_Payload =>
             True);
   ...
   function Get_Flags (Ctx : Context) return RFLX.Control_Packet.Header_Flags is
     (To_Actual (Ctx.Cursors (F_Flags).Value));

   function Get_Remaining_Length (Ctx : Context) return RFLX.Control_Packet.Single_Byte_Remaining_Length is
   ...
   function Sufficient_Buffer_Length (Ctx : Context; Struct : Structure) return Boolean is
     (RFLX_Types.Base_Integer (RFLX_Types.To_Last_Bit_Index (Ctx.Buffer_Last) - RFLX_Types.To_First_Bit_Index (Ctx.Buffer_First) + 1) >= RFLX_Types.Base_Integer (Struct.Remaining_Length) * 8 + 16);
   ...
   function Field_Size_Payload (Struct : Structure) return RFLX_Types.Bit_Length is
     (RFLX_Types.Bit_Length (Struct.Remaining_Length) * 8);

end RFLX.Control_Packet.Incoming_Packet;
