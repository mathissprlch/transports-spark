...
package RFLX.Session.Broker_Reading.FSM
with
  SPARK_Mode
is
   ...
   type State is (S_Awaiting_Connect, S_Forwarding_Connect, S_Reading, S_Forwarding, S_Final);
     ...
     Post =>
       ...
       and then (if
                 ...
                 then
                    ...
                    and Session.Broker_Reading.FSM.Written_Last (Ctx, B_Inbound) = Session.Broker_Reading.FSM.Written_Last (Ctx, B_Inbound)'Old)
...
private
   ...
   type Private_Context is
      record
         Next_State : State := S_Awaiting_Connect;
