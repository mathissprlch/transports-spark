...
package body RFLX.Pingreq.Packet
with
  SPARK_Mode
is
   ...
   with
     Pre =>
       ...
       and RFLX.Pingreq.Packet.Valid_Next (Ctx, Fld);
   ...
   with
     Pre =>
       ...
       and then RFLX.Pingreq.Packet.Sufficient_Buffer_Length (Ctx, Fld)
   is
   ...
   with
     Pre =>
       ...
       and then RFLX.Pingreq.Packet.Valid_Size (Ctx, Fld, Size)
       and then Size <= RFLX.Pingreq.Packet.Available_Space (Ctx, Fld)
   ...
   with
     Pre =>
       ...
       and then RFLX.Pingreq.Packet.Valid_Value (Fld, Val)
       and then RFLX.Pingreq.Packet.Valid_Size (Ctx, Fld, RFLX.Pingreq.Packet.Field_Size (Ctx, Fld))
       and then RFLX.Pingreq.Packet.Available_Space (Ctx, Fld) >= RFLX.Pingreq.Packet.Field_Size (Ctx, Fld)
       and then RFLX.Pingreq.Packet.Field_Size (Ctx, Fld) in 1 .. RFLX_Types.Base_Integer'Size
       and then RFLX_Types.Fits_Into (Val, Natural (RFLX.Pingreq.Packet.Field_Size (Ctx, Fld))),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, Fld)
   ...
   procedure Set_Reserved (Ctx : in out Context; Val : RFLX.Pingreq.Reserved_Flags) is
   begin
      Set_Scalar (Ctx, F_Reserved, RFLX.Pingreq.To_Base_Integer (Val));
   end Set_Reserved;

   procedure Set_Remaining_Length (Ctx : in out Context; Val : RFLX.Pingreq.Remaining_Length) is
   begin
      Set_Scalar (Ctx, F_Remaining_Length, RFLX.Pingreq.To_Base_Integer (Val));
