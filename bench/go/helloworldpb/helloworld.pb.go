...
const file_helloworld_proto_rawDesc = "" +
	...
	"\aGreeter\x12<\n" +
	"\bSayHello\x12\x18.helloworld.HelloRequest\x1a\x16.helloworld.HelloReply\x12C\n" +
	"\rLotsOfReplies\x12\x18.helloworld.HelloRequest\x1a\x16.helloworld.HelloReply0\x01\x12E\n" +
	"\x0fLotsOfGreetings\x12\x18.helloworld.HelloRequest\x1a\x16.helloworld.HelloReply(\x01\x12A\n" +
	"\tBidiHello\x12\x18.helloworld.HelloRequest\x1a\x16.helloworld.HelloReply(\x010\x01B\x18Z\x16perf-test/helloworldpbb\x06proto3"
